...
@interface ChildViewControllersTuple ()
...
@implementation ChildViewControllersTuple {
...
// Algorithms
- (ChildViewControllersTuple*)map:(id (^)(id x))mapping {
    
    ChildViewControllersTuple* newtup = [self copy];
